...
Aplicación para el módulo de inteligencia que se instala en el dispositivo en el borde.
...
FLASK_ENV=development FLASK_DEBUG=0 FLASK_APP=./entrypoint/app.py flask run
```
...
``` 
docker container exec -it tfm-local-bridge /bin/sh
